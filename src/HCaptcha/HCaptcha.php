...
class HCaptcha
{
 ...
 public function getAttributesString() {
  ...
  if (!empty($attributes['data-size']) && $attributes['data-size'] === 'invisible') {
    if (!isset($attributes['data-callback']) || $attributes['data-callback'] === '') {
      $attributes['data-callback'] = 'hcaptchaInvisibleOnSubmit';
    }
  }
